                    ...
                    @if(!empty($pengajuanBeasiswaData))
                        @foreach($pengajuanBeasiswaData as $pengajuanBeasiswa)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('pengajuanBeasiswa.detail', ['users_id' => $pengajuanBeasiswa->users_id, 'jenisBeasiswa_id' => $pengajuanBeasiswa->jenisBeasiswa_id, 'periodeBeasiswa_id' => $pengajuanBeasiswa->periodeBeasiswa_id]) }}">
                                        Detail
                                    </a>
                                </td>
