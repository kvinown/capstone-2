                ...
                <form method="post" action="{{ route('pengajuanBeasiswa.store') }}">
                    ...
                    <div class="card-body bg-secondary rounded-3">
                        ...
                        <div class="form-group m-2">
                            ...
                            <input type="text" class="form-control" id="ipk" placeholder="Masukan IPK Terakhir" required name="ipk">
                        </div>
                        <div class="form-group m-2">
                            <label for="poin" class="text-white mb-3">Poin Portofolio</label>
                            <input type="text" class="form-control" id="poin" placeholder="Masukan Poin Portofolios" required name="point_portofolio">
                        </div>
                    </div>
